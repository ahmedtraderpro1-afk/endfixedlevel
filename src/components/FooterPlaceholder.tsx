        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr_1fr_1fr_1fr] gap-8 border-b border-[#c5a059]/10 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#signature-collection" className="hover:text-[#c5a059] transition-colors">Collections</a></li>
              <li><a href="#the-bridal-edit" className="hover:text-[#c5a059] transition-colors">Bridal Jewelry</a></li>
              <li><a href="#shop-by-category" className="hover:text-[#c5a059] transition-colors">Necklaces</a></li>
              <li><a href="#shop-by-category" className="hover:text-[#c5a059] transition-colors">Earrings</a></li>
              <li><a href="#shop-by-category" className="hover:text-[#c5a059] transition-colors">Pearl Collections</a></li>
            </ul>
          </div>
